...
//      System.out.println(level+"/"+count+"="+result);
    ...
    public int increment(long key, int amount){
        if (amount <= 0){
            throw new IllegalArgumentException(
                    "IntValueLongHashMap.increment��amount�������0: " + amount);
        }
        Entry tab[] = table;
        int hash = hashLong(key);
        int index = getIndex(hash);
            ...
            if (e.key == key){
                ...
                if (result <= 0){
                    throw new IllegalStateException(
                            "IntValueLongHashMap.increment��, ������amount��, ����<=0��. �ӵ�amount: "
                                    + amount + ", ������֮��: " + result);
                }
    ...
    public int decrement(long key, int amount){
        if (amount <= 0){
            throw new IllegalArgumentException(
                    "IntValueLongHashMap.decrement��amount�������0: " + amount);
        }
        Entry tab[] = table;
        ...
        for (Entry e = tab[index], prev = null; e != null; prev = e, e = e.next){
            if (e.key == key){
                ...
                // �е����� < Ҫ�۵�, �״�
                throw new IllegalStateException("IntValueLongHashMapʱ, Ҫ�� "
                        + amount + ", ��ԭ��ֻ�� " + e.value);
            }
        }
        // û�ҵ�, �״�
        throw new NoSuchElementException(
                "IntValueLongHashMap.decrementʱ, keyû�ҵ�: " + key);
    }
