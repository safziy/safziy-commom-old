...
import com.safziy.collection.temp.LongConcurrentKeygenMap.LongKeySetter;
...
public class LongConcurrentKeygenMap<V extends LongKeySetter> {
    ...
    static final <V extends LongKeySetter> LongConcurrentKeygenMap<V>[] newArray(
            int i){
...
//           this.key = key;
    ...
    final class EntryIterator extends HashIterator implements
            ReusableIterator<LongHashMap.Entry<V>>{
        @Override
    ...
    final class EntrySet extends AbstractSet<LongHashMap.Entry<V>>{
        ...
        public boolean remove(Object o){
            ...
            LongHashMap.Entry<?> e = (LongHashMap.Entry<?>) o;
            return LongConcurrentKeygenMap.this
                    .remove(e.getKey(), e.getValue()) != null;
        }
