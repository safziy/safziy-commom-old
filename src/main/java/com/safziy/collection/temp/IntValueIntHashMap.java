...
//    	System.out.println(level+"/"+count+"="+result);
    ...
    public int increment(int key, int amount){
        if (amount <= 0){
            throw new IllegalArgumentException(
                    "IntValueIntHashMap.increment��amount�������0: " + amount);
        }
        Entry tab[] = table;
        int index = getIndex(key);
            ...
            if (e.hash == key){
                ...
                if (result <= 0){
                    throw new IllegalStateException(
                            "IntValueIntHashMap.increment��, �������amount��, ����<=0��. �ӵ�amount: "
                                    + amount + ", �������֮��: " + result);
                }
    ...
    public int decrement(int key, int amount){
        if (amount <= 0){
            throw new IllegalArgumentException(
                    "IntValueIntHashMap.decrement��amount�������0: " + amount);
        }
        Entry tab[] = table;
        int index = getIndex(key);
        for (Entry e = tab[index], prev = null; e != null; prev = e, e = e.next){
            if (e.hash == key){
                ...
                // �е����� < Ҫ�۵�, �״�
                throw new IllegalStateException("IntValueIntHashMapʱ, Ҫ�� "
                        + amount + ", ��ԭ��ֻ�� " + e.value);
            }
        }
        // û�ҵ�, �״�
        throw new NoSuchElementException(
                "IntValueIntHashMap.decrementʱ, keyû�ҵ�: " + key);
    }
